...
def Lof3(nome_fich, df,rootdir2):
    ...
    if ncount > 20:
        ...
        tuner = LOF_AutoTuner(data = data, k_max = 20, c_max = 0.1)
        K,C = tuner.run()
        ...
        if len(out) !=0:
            ...
            m = folium.Map(location=[df.Lat.mean(),  df.Long.mean()],  zoom_start=16, tiles='Stamen Toner')
            ...
            m.save("./Map_images LOF/"+nome_fich+'_geo.html')
